...
export const environment = {
    production: false,
    staging: false,
    irBasePath: 'https://rnavlav.gla-rad.org/mcp/mir',
    irProvider: 'GLA Research & Development Directorate',
    irContact: 'glaresearchdevelopment@gmail.com',
    oidcBasePath: 'http://hermes.grad-rrnav.pub:8090',
    hasServiceRegistry: true,
    srBasePath: 'https://rnavlav.gla-rad.org/mcp',
    srProvider: 'GLA Research & Development Directorate',
    srContact: 'http://hermes.grad-rrnav.pub:8545',
    hasMSRLedger: true,
